    ...
    <div>
                ...
                <div v-if="orderList.length" style="min-height: 10vw; border-bottom:1px solid #ededed;">
                    <div v-for="(item,index) in orderList" :key="i">
                        ...
                        <div class="pr" style="position:relative;">
                            <div class="cart" v-for="(item,i) in orderList" :key="j">
                                <div class="cart-l" :class="{bt:j>0}">
                                    <div class="car-l-l">
                                        <div class="img-box"><a><img v-lazy="`static/${item.productImg}`" alt=""></a>
                                        </div>
                                    ...
                                    <div class="cart-l-r">
                                        ...
                                        <div class="type">
                                            <button style="margin-left:20px" class="del-order"
                                                    @click="delOrderList(item)">删除此订单
                                            </button>
                            ...
                            <div class="prod-operation pa" style="position:absolute; right: 0;top: 0;">
                                ...
                                <div class="pay-content">
                                    <button class="payBtn" @click="payOrder(item)" v-show="item.ifPay===0?true:false">
                                        现在付款
                                    </button>
        ...
        <pay-suc :mdShow="mdShow" v-on:close="closeModal">
            ...
            <div class="pay-type" slot="message" v-if="payShow">
                <p style="font-size:14px; font-weight: 700; text-align:right;">
                    *请注意,付款是不会发货的,视为自动捐赠,请勿轻易付款,该作者承担不起任何责任,谢谢配合!</p>
                <div class="p-title">支付方式</div>
                <div class="pay-item">
                    <div :class="{'active':selectType === index}" v-for="(item,index) in payList"
                         @click="select(index)">
                        <img :src="item.imgUrl">
                    </div>
                </div>
